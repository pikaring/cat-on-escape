...
| ファイル | 中身 | サイズ |
| --- | --- | --- |
| `app/images/face-kuro.png` ほか5枚 | 猫の顔（くろ・ちゃしろ・キジトラ・ハチワレ・みけ） | 512×512px |
...
【並べかた（厳守）】
・3列×2行の6マス。左上から右へ、1段目に3匹、2段目に2匹を置き、右下の1マスは空ける
・順番は 1:くろねこ 2:ちゃしろ 3:キジトラ 4:ハチワレ 5:みけねこ
...
これも**2列×2行のグリッドで1枚**にまとめると画風がそろいます。
